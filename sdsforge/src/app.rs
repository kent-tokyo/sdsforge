...
• Use --help for CLI usage: sdsforge --help",
        ...
        "zh-cn" => Strings {
            ...
            msg_start:        "▶ 开始",
            msg_done_batch:   "✓ 完成",
            about_title:      "关于 sdsforge",
            about_desc:       "将SDS文档转换为MHLW标准JSON的工具",
            menu_manual: "使用手册",
            manual_title: "sdsforge 使用说明",
            manual_body: "\
【转换标签 (to-json)】
...
• CLI用法: sdsforge --help",
        ...
        _ => Strings {  // Japanese (ja, default)
            ...
            msg_start:        "▶ 開始",
            msg_done_batch:   "✓ 完了",
            about_title:      "sdsforge について",
            about_desc:       "SDS文書をMHLW標準JSONへ変換するツール",
            menu_manual: "マニュアル",
            manual_title: "sdsforge 使い方",
            manual_body: "\
【変換タブ (to-json)】
...
impl SdsApp {
    ...
    fn ui_welcome_screen(&mut self, ui: &mut egui::Ui) {
        ...
        ui.vertical_centered(|ui| {
            ...
            ui.add_space(14.0);
            ui.label(egui::RichText::new("sdsforge").size(30.0).strong());
            ui.label(
        ...
        if self.show_about {
            ...
            let modal_resp = egui::Modal::new(egui::Id::new("about_dlg"))
                .show(&ctx, |ui| {
                    ...
                    ui.add_space(4.0);
                    ui.label(concat!("sdsforge v", env!("CARGO_PKG_VERSION")));
                    ui.add_space(4.0);
